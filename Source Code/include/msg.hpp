...
enum DaemonCommands : int {
  ...
  // Commands used by the 2.5B Toolbox/daemon but missing from the published header.
  // Explicit IDs preserve the existing daemon IPC ABI.
  BREW_LAUNCH_DUMPER = 0x9000013,
  BREW_ADJUST_FAN_SPEED = 0x9000014,
  BREW_PIZZAHEN_SHELL_SERVICE = 0x9000016, // FIX70.33 source-grounded lazy ShellUI service
  ...
  BREW_UTIL_GET_GAMES_LIST = 0x8000010,
  BREW_UTIL_LAUNCH_GAME_BY_BUTTON_ID = 0x8000011,
  BREW_UTIL_SCAN_USB_PKGS = 0x8000012,
  // FIX70.24: owned web Toolbox functional backends.
  BREW_UTIL_DOWNLOAD_STORE = 0x8000013,
  BREW_UTIL_SCAN_PLUGINS = 0x8000014,
  BREW_UTIL_STOP_PLUGIN = 0x8000015,
  BREW_UTIL_SET_PLUGIN_AUTOSTART = 0x8000016,
  BREW_UTIL_REFRESH_PAYLOAD_REPO = 0x8000017,
  BREW_UTIL_INSTALL_PAYLOAD_REPO = 0x8000018,
