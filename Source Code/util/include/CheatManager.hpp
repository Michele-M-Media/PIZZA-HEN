...
#define CHEATS_DIRECTORY "/data/PIZZA_HEN/cheats"
#define JSON_CHEATS_LIST "/data/PIZZA_HEN/cheats/json.txt"
#define MC4_CHEATS_LIST "/data/PIZZA_HEN/cheats/mc4.txt"
#define SHN_CHEATS_LIST "/data/PIZZA_HEN/cheats/shn.txt"
