...
void update_cheat_caches() {
  ...
  mkdir("/data/PIZZA_HEN/cheats", 0777);
  mkdir("/data/PIZZA_HEN/cheats/shn", 0777);
  mkdir("/data/PIZZA_HEN/cheats/mc4", 0777);
  mkdir("/data/PIZZA_HEN/cheats/json", 0777);

  // Update JSON cache
  update_cache_for_dir("/data/PIZZA_HEN/cheats/json",
                       "/data/PIZZA_HEN/cheats/json.txt", ".json",
                       extract_game_name_from_json);

  // Update SHN cache
  update_cache_for_dir("/data/PIZZA_HEN/cheats/shn", "/data/PIZZA_HEN/cheats/shn.txt",
  ...
  update_cache_for_dir("/data/PIZZA_HEN/cheats/mc4", "/data/PIZZA_HEN/cheats/mc4.txt",
