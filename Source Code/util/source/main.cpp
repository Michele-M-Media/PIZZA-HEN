...
void LoadSettings(void) {
    if (if_exists("/data/PIZZA_HEN/config.ini")) {
        IniParser parser;

        if (ini_parser_load(&parser, "/data/PIZZA_HEN/config.ini")) {
...
int main(void) {
    ...
    unlink("/data/PIZZA_HEN/etaHEN_util_daemon.log");
    unlink("/data/PIZZA_HEN/etaHEN_util_crash.log");
