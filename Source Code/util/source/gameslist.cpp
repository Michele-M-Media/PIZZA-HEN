...
{
  struct dirent *entry;
  unlink("/data/PIZZA_HEN/games_list.xml");

  std::vector<std::string> directories = {
    "/user/data/PIZZA_HEN/games",
    "/mnt/usb0/PIZZA_HEN/games",
    "/mnt/usb1/PIZZA_HEN/games",
    "/mnt/usb2/PIZZA_HEN/games",
    "/mnt/usb3/PIZZA_HEN/games",
    "/mnt/ext1/PIZZA_HEN/games",
    "/mnt/ext2/PIZZA_HEN/games",
    "/mnt/ext0/PIZZA_HEN/games",
  };
  ...
  mkdir("/data/PIZZA_HEN/cache", 0777);
  ...
  for (const auto &directory : directories)
  {
    ...
    while ((entry = readdir(dir)) != nullptr)
    {
      ...
      if (isExternalStorage(game_dir)) {
        ...
        std::string cached_icon_path = "/user/data/PIZZA_HEN/cache/" + title_id + ".png";
