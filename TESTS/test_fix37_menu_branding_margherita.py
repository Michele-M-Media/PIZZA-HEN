...
ok('FIX37_DYNAMIC_PIZZA_HEN_BRANDING', all(x in hf for x in ['PIZZA HEN is currently installing the selected PKG', 'PIZZA HEN PKG Sort', 'PIZZA HEN Toolbox']) and '★ PIZZA HEN Cheats' not in hf)
